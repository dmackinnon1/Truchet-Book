...
\noindent
Each 4x4 Truchet pattern can be treated like a tile and used in a larger pattern. A \textit{frieze} is a horizontal strip of tiles. Laying each of the 256 tiles in a frieze of the same tiles reveals other symmetrical patterns.
