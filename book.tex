...
\marginnote{\centering\input{intro_generated_files/tileList2.gtex}} Both individual tiles and their families can be described by their signatures. The signature of the family of a tile can be found by considering the tile's signature $\pmod{2}$.
